...
# Credit to Rick Muller, https://github.com/rpmuller/svgscene
...
class SVGScene:
    ...
    def _repr_svg_(self): return str(self.to_svg())
...
class Text:
    ...
    def bbox(self):
        return self.origin[0],self.origin[0]+len(self.text)*self.size,self.origin[1],self.origin[1]+self.size # Guessing here
